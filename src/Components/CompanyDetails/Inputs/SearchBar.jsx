    ...
    <>
      ...
      <form onSubmit={handleSubmit} className='d-flex flex-row justify-content-center text-light form'>
        <input
          ...
          value={inputValue} />
        <button type="submit" value='Search' className='btn border text-center border-danger mx-3' disabled={!validText} ><MdManageSearch className='p-0 m-0 text-light fs-4'/></button>
      </form>
